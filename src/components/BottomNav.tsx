...
export function BottomNav() {
  ...
  return (
    <nav className="fixed bottom-0 left-1/2 z-40 w-full max-w-[430px] -translate-x-1/2 px-4 pb-4">
      <div className="flex items-center justify-around rounded-full border border-border/60 bg-surface-1/85 px-2 py-3 shadow-[0_-8px_32px_rgba(0,0,0,0.4)] backdrop-blur-xl dark:border-white/10 dark:bg-[oklch(0.2_0.02_250_/_0.78)] dark:shadow-[0_-10px_36px_rgba(0,0,0,0.65)]">
